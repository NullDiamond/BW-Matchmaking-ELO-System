...
import com.example.elocalculator.model.game.*;
import com.example.elocalculator.model.elo.*;
import com.example.elocalculator.model.result.*;
...
public class GameProcessor {
    ...
    public String getPlayerNameFromMatch(GameData gameData, String uuid) {
        ...
        if (gameData.getTeams() != null) {
            for (List<com.example.elocalculator.model.player.PlayerIdentifier> teamPlayers : gameData.getTeams().values()) {
                if (teamPlayers != null) {
                    for (com.example.elocalculator.model.player.PlayerIdentifier player : teamPlayers) {
