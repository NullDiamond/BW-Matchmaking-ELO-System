...
public class GameProcessor {
    ...
    public String getPlayerNameFromMatch(GameData gameData, String uuid) {
        ...
        if (gameData.getTeams() != null) {
            for (List<com.nulldiamond.elocalculator.model.player.PlayerIdentifier> teamPlayers : gameData.getTeams().values()) {
                if (teamPlayers != null) {
                    for (com.nulldiamond.elocalculator.model.player.PlayerIdentifier player : teamPlayers) {
