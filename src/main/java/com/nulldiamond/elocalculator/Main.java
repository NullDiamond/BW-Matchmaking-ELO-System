...
import com.nulldiamond.elocalculator.managers.EloCalculator;
import com.nulldiamond.elocalculator.managers.GameModeUtils;
import com.nulldiamond.elocalculator.managers.MatchAnalyzer;
import com.nulldiamond.elocalculator.managers.OutputManager;
import com.nulldiamond.elocalculator.managers.TeamBalancer;
...
public class Main {
    ...
    public void showPlayerHistory(String playerName) {
        try {
            com.nulldiamond.elocalculator.managers.EloHistoryManager historyManager = 
                new com.nulldiamond.elocalculator.managers.EloHistoryManager(dataDirectory);
